  ...
  <div class="container" style="left: 50%; margin-left: -180px">
    <div class="form-box register-box">
      <div class="form">
        ...
        <input v-model="input_name" type="text" placeholder="请输入您的姓名" class="input">
        <input v-model="input_email" type="email" placeholder="请输入您的电子邮箱" class="input">
        ...
        <router-link to="employee_login" id="loginBut" class="link">登录</router-link>
      </div>
    </div>
  </div>
</template>
